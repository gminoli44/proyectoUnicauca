    ...
    class conexion{
      ...
      //---------------- GET--------------------//  
        ...
        public function getCarreras(){
            $this->resultado = $this->db->query("SELECT sniesprograma, nombre_progra FROM activos2018 INNER JOIN cod_snies ON sniesprograma=cod GROUP BY sniesprograma");
        ...
        public function getProgramas($nivel){
            $this->resultado = $this->db->query("SELECT sniesprograma, nombre_progra FROM activos2018 INNER JOIN cod_snies ON sniesprograma=cod WHERE nivel='$nivel' GROUP BY sniesprograma");
            return $this->resultado;
        }
        ...
        public function getEstudiantesDeptoCarTotal($snies,$codDepto,$regionalizacion){
            $this->resultado = $this->db->query("SELECT COUNT('digoe') as cantidad FROM activos2018 WHERE activos2018.SNIESPROGRAMA='$snies' and activos2018.CODIGODPTO='$codDepto'".$regionalizacion);
            return $this->resultado;
        }
        
         public function getEstudiantesMuniCarTotal($snies,$codDepto,$codMuni){
            $this->resultado = $this->db->query("SELECT COUNT('digoe') as cantidad FROM activos2018 WHERE activos2018.SNIESPROGRAMA='$snies' and activos2018.CODIGODPTO='$codDepto' and activos2018.CODIGOMUN='$codMuni';");
            return $this->resultado;
        }
